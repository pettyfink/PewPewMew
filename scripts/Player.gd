...
onready var res_unarmed_p = preload("res://scenes/unarmed_p.tscn")
onready var res_knife_p = preload("res://scenes/knife_p.tscn")

onready var res_pistol_p = preload("res://scenes/pistol_p.tscn")
onready var res_pistol_w = preload("res://scenes/pistol_w.tscn") # Just testing
onready var res_akimbo_pistol_p = preload("res://scenes/akimbo_pistol_p.tscn")
